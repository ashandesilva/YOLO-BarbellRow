...
# %%
# Define the PoseGCN model with dropout for regularization.
...
model = PoseGCN(num_features=2, hidden_channels=32, num_classes=2, dropout_prob=0.5)
...
torch.save(model.state_dict(), "pose_gcn_dropout_model.pt")
print("Model saved as pose_gcn_dropout_model.pt")
