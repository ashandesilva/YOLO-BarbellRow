...
# %%
# Define the PoseGCN model (using the original two-layer version).
...
# %%
# Training loop with scheduler update.
num_epochs = 100
...
torch.save(model.state_dict(), "pose_gcn_scheduler_model.pt")
print("Model saved as pose_gcn_scheduler_model.pt")
